...
// e cidade. Cada par-valor é separado por vígula e para definir o valor de uma chave usa-se
...
$alunos = array( array("nome" => "Gabriela", "dt_nasc" => "03/02/2003", "cidade" => "Mococa"), // i 0 
                 ...
                 array("nome" => "Alysson", "dt_nasc" => "15/07/2003", "cidade" => "Mococa"), // i 2
                 array("nome" => "Ana Xavier", "dt_nasc" => "09/10/2002", "cidade" => "Marte") // i 3
               );
// Como se lê? "Acessando o índice 1 do array alunos. No índice 1 há outro array, um associativo
